...
public class LbsNearQuery {
    ...
    /**
     * Creates a new {@link LbsNearQuery}.
     *
     * @param point must not be {@literal null}.
     */
    private LbsNearQuery(Point point, Metric metric) {
    ...
    /**
     * Creates a new {@link LbsNearQuery} starting near the given coordinates.
     *
     * @param x
     * @param y
     * @return
     */
    public static LbsNearQuery near(double x, double y) {
        return near(x, y, null);
    }

    /**
     * Creates a new {@link LbsNearQuery} starting at the given coordinates using the given {@link Metric} to adapt given
     ...
     * @return
     */
    public static LbsNearQuery near(double x, double y, Metric metric) {
        return near(new Point(x, y), metric);
    }

    /**
     * Creates a new {@link LbsNearQuery} starting at the given {@link Point}.
     *
     * @param point must not be {@literal null}.
     * @return
     */
    public static LbsNearQuery near(Point point) {
        return near(point, null);
    }

    /**
     * Creates a {@link LbsNearQuery} starting near the given {@link Point} using the given {@link Metric} to adapt given
     * values to further configuration. E.g. setting a {@link #maxDistance(double)} will be interpreted as a value of the
     * initially set {@link Metric}.
     *
     * @param point  must not be {@literal null}.
     ...
     * @return
     */
    public static LbsNearQuery near(Point point, Metric metric) {
        return new LbsNearQuery(point, metric);
    }
     ...
     * @return
     */
    public LbsNearQuery num(int num) {
        this.num = num;
        return this;
    }
     ...
     * @return
     */
    public LbsNearQuery skip(int skip) {
        this.skip = skip;
        return this;
    }
     ...
     * @return
     */
    public LbsNearQuery with(Pageable pageable) {
     ...
     * <p>
     * <pre>
     * LbsNearQuery query = near(10.0, 20.0, Metrics.KILOMETERS).maxDistance(150);
     * </pre>
     * <p>
     ...
     * @return
     */
    public LbsNearQuery maxDistance(double maxDistance) {
     ...
     * @return
     */
    public LbsNearQuery maxDistance(double maxDistance, Metric metric) {
     ...
     * @return
     */
    public LbsNearQuery maxDistance(Distance distance) {
     ...
     * <p>
     * <pre>
     * LbsNearQuery query = near(10.0, 20.0, Metrics.KILOMETERS).minDistance(150);
     * </pre>
     * <p>
     ...
     * @since 1.7
     */
    public LbsNearQuery minDistance(double minDistance) {
     ...
     * @since 1.7
     */
    public LbsNearQuery minDistance(double minDistance, Metric metric) {
     ...
     * @since 1.7
     */
    public LbsNearQuery minDistance(Distance distance) {
     ...
     * @return
     */
    public LbsNearQuery distanceMultiplier(double distanceMultiplier) {
     ...
     */
    @Deprecated
    public LbsNearQuery distanceMultiplier(Metric metric) {
     ...
     * @return
     */
    public LbsNearQuery spherical(boolean spherical) {
     ...
     * @return
     */
    public LbsNearQuery inKilometers() {
     ...
     * @return
     */
    public LbsNearQuery in(Metric metric) {
     ...
     * @param metric
     */
    private LbsNearQuery adaptMetric(Metric metric) {
    ...
    /**
     * Adds an actual query to the {@link LbsNearQuery} to restrict the objects considered for the actual near operation.
     *
     * @param query must not be {@literal null}.
     * @return
     */
    public LbsNearQuery query(Query query) {

        Assert.notNull(query, "Cannot apply 'null' query on LbsNearQuery.");
        this.query = query;
    ...
    /**
     * Returns the {@link DBObject} built by the {@link LbsNearQuery}.
     *
     * @return
     */
    public DBObject toDBObject() {
        ...
        if (point instanceof GeoJsonPoint) {
            GeoJsonPoint geoJsonPoint = (GeoJsonPoint) point;
            BasicDBObject pointObject = new BasicDBObject();
            pointObject.put("type", geoJsonPoint.getType());
            pointObject.put("coordinates", geoJsonPoint.getCoordinates());
            dbObject.put("near", pointObject);
        } else {
